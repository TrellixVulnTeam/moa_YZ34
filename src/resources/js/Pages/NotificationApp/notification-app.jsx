...
import NotificationHandPhone from "./../../assets/img/notification-hand-phone.png";
...
import right from './assets/nright.svg'
import playIcon from './assets/nplay-icon.svg'
            ...
            <div className='na-header-wrapper'>
                <div className='na-header-text'>
                    ...
                    <div className='na-btn-container'>
                        ...
                        <ActionButton video="true" videoId="mTHgPN5i5v0" text="Watch the video" variant="transparent" href="#" className="px-5 text-light" iconClass="bi bi-play-circle ps-2" />
                    </div>
                </div>
            </div>
