...
import CasinoLicence from "./../../assets/img/casino-licence.png";
...
import right from './assets/gs-right.svg'
    ...
    return (
        <>     <div className='gs-wrapper'>
            ...
            <div className='gs-section-wrapper-last gs-section-grey'>
                ...
                <button className='casino-header-contact-btn'>
                    <a href='/gaming-sports'>
                        <span>Read More</span>
                        <img src={right} />
                    </a>
                </button>
            </div>
            <div className='gbs-why-choose-wrapper gs-why-choose-wrapper'>
                <div>
