...
const App = () => {
    return (<BrowserRouter>
        <Routes>
            ...
            />
            <Route
                path="sportsbettingsoftware"
                element={<SportsBettingSoftware />}
            />
            ...
            <Route
                path="white-label-solution"
                element={<WhiteLabelSolution />}
            />
            ...
            />
            <Route
                path="world-class-solutions"
                element={<WorldClassSolutions />}
            />
            ...
            <Route path="casino-and-betting" element={<CasinoBetting />} />
            ...
            <Route path='casino-and-betting-2' element={<CasinoAndBetting2 />} />
