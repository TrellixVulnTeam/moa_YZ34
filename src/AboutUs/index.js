    ...
    <div className='about-us-top-wrapper'>
      ...
      <div className='about-us-who-we-are-wrapper'>
        ...
        <p>
          ...
          with the idea of MOA gaming. With our main development office based in
          Armenia, our international company has managed to come a long way.
        </p>
        <p>
        ...
        <p>
          ...
          industry, offering services to operators from all over the world. Our
          products include{' '}
          <strong>
            Sports Betting, Gaming Suite, Affiliate and Agent Platform, Payment
            Solution, Notification App
          </strong>
          ...
          <div className='about-us-our-mission-box'>
            ...
            <div className='about-us-our-mission-box-text-wrapper'>
              ...
              <p>
                ...
                betting and gaming world, so all our solutions and software can
                be adapted and customized to your business and target market.
              </p>
            </div>
          </div>
      ...
      <div className='about-us-vision-wrapper'>
        <div className='about-us-img-bg'>
          <h1>Our Vision</h1>
          <p>
            iGaming industry Together With You, We Can Make a Difference in the.
          </p>
          <button>
            <a href='/'>
